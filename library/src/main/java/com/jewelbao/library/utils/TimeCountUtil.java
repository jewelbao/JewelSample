...
public class TimeCountUtil extends CountDownTimer
{
	...
	public void onTick(long millisUntilFinished) {
		...
		btn.setText("重新获取(" + millisUntilFinished / 1000 + ")");//设置倒计时时间

		//设置按钮为灰色，这时是不能点击的
//		btn.setBackground(mActivity.getResources().getDrawable(R.drawable.bg_code_disable));
//		btn.setTextColor(mActivity.getResources().getColor(R.color.dialog_divider));
...
//		btn.setBackground(mActivity.getResources().getDrawable(R.drawable.bg_login_btn));//还原背景色
