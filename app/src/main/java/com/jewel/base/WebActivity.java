...
import com.jewelbao.library.utils.StringUtils;
...
public class WebActivity extends Activity {
    ...
    private View createContentView() {
        ...
        mTitle.setPadding(DensityUtil.dp2px(this, 20), 0, DensityUtil.dp2px(this, 20), 0);
        LinearLayout.LayoutParams titleParams = new LinearLayout.LayoutParams(LinearLayout
                .LayoutParams.MATCH_PARENT, DensityUtil.dp2px(this, 45));
        ...
        LinearLayout.LayoutParams progressParams = new LinearLayout.LayoutParams(LinearLayout
                .LayoutParams.MATCH_PARENT, DensityUtil.dp2px(this, 3));
    ...
    private WebViewClient mWebViewClient = new WebViewClient() {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            JLog.v("WebView Page Started");
        }

        @Override
        public void onPageFinished(WebView view, String url) {
            JLog.v("WebView Page Finished");
        }

        @Override
        public void onLoadResource(WebView view, String url) {
            JLog.v("WebView Load Resource");
        }
