...
public class WindView extends SkyconView
{
	...
	public void onDraw(Canvas canvas)
	{
		...
		} else
		{
			...
			tracePath.cubicTo(X + (screenW / 3.2f), Y + (screenW / 12), X + (screenW / 2.0f),
							  Y - (screenW / 3.2f), X + (screenW / 2.5f), Y - (screenW / 2.8235f));
			tracePath.cubicTo(X + (screenW / 2.7f), Y - (screenW / 2.7428f), X + (screenW / 3.2f),
							  Y - (screenW / 3f), X + (screenW / 3.0f), Y - (screenW / 3.6923f));
			tracePath.cubicTo(X + (screenW / 2.6f), Y - (screenW / 6), X + (screenW / 1.5f),
							  Y - (screenW / 9.6f), screenW + 50, Y - (screenW / 2.4f));
		...
		if((int) count < 250)
		{
			...
			X11 = (float) (((screenW * 4) / 100) * Math
					.cos(Math.toRadians((degrees + count) - 30)) + Xc);
			Y11 = (float) (((screenW * 4) / 100) * Math
					.sin(Math.toRadians((degrees + count) - 30)) + Yc);
			X21 = (float) (((screenW * 12) / 100) * Math
					.cos(Math.toRadians((degrees + count))) + Xc);
			Y21 = (float) (((screenW * 12) / 100) * Math
					.sin(Math.toRadians((degrees + count))) + Yc);
