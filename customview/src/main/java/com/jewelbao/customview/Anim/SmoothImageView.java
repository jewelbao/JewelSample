...
public class SmoothImageView extends ImageView
{
	...
	protected void onDraw(Canvas canvas) {
		...
		if (mState == STATE_TRANSFORM_IN || mState == STATE_TRANSFORM_OUT) {
			...
			if(mTransformStart){
//				JLog.d("mTransfrom.startScale:"+mTransfrom.startScale);
//				JLog.d("mTransfrom.startScale:"+mTransfrom.endScale);
//				JLog.d("mTransfrom.scale:"+mTransfrom.scale);
//				JLog.d("mTransfrom.startRect:"+mTransfrom.startRect.toString());
//				JLog.d("mTransfrom.endRect:"+mTransfrom.endRect.toString());
//				JLog.d("mTransfrom.rect:"+mTransfrom.rect.toString());
			}
